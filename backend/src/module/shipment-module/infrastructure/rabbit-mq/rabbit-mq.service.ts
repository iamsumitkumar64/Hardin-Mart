...
export class RabbitMQService implements OnModuleInit, OnModuleDestroy {
    ...
    async connectToRabbitMQ() {
        ...
        try {
            ...
            this.logger.log("Connected to RabbitMQ - Shipment Module");
        } catch (error) {
    ...
    private async setupInitialCreation() {
        ...
        // Setup shipment queue bound to multiple exchanges (fanout - no routing key)
        await this.setupFanoutExchangeAndQueue(this.SHIPMENT_QUEUE, this.USER_EXCHANGE);
        await this.setupFanoutExchangeAndQueue(this.SHIPMENT_QUEUE, this.SALE_EXCHANGE);
        await this.setupFanoutExchangeAndQueue(this.SHIPMENT_QUEUE, this.BILLING_EXCHANGE);
    ...
    async closeConnection() {
        try {
            ...
            this.logger.log("RabbitMQ connection closed - Shipment Module");
        } catch (error) {
