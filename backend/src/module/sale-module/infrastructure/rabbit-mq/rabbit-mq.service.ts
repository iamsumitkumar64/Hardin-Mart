...
export class RabbitMQService implements OnModuleInit, OnModuleDestroy {
    ...
    async connectToRabbitMQ() {
        ...
        try {
            ...
            this.logger.log("Connected to RabbitMQ - Sale Module");
        } catch (error) {
    ...
    private async setupInitialCreation() {
        ...
        // Setup sale queue bound to multiple exchanges (fanout - no routing key)
        await this.setupFanoutExchangeAndQueue(this.SALE_QUEUE, this.USER_EXCHANGE);
        await this.setupFanoutExchangeAndQueue(this.SALE_QUEUE, this.BILLING_EXCHANGE);
        await this.setupFanoutExchangeAndQueue(this.SALE_QUEUE, this.SHIPPING_EXCHANGE);
    ...
    async closeConnection() {
        try {
            ...
            this.logger.log("RabbitMQ connection closed - Sale Module");
        } catch (error) {
